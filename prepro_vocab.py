...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', type=str, default='json_not_only_files/corpus_sign_word2_small_val_test.json',
                        help='msr_vtt videoinfo json')
    parser.add_argument('--info_json', default='json_not_only_files/info.json',
                        help='info about iw2word and word2ix')
    parser.add_argument('--caption_json', default='json_not_only_files/caption.json', help='caption json file')
