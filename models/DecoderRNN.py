...
class DecoderRNN(nn.Module):
    ...
    def forward(self,
        ...
        if mode == 'train':
            ...
            for i in range(self.max_length - 1):
                ...
                # decoder_input = torch.nn.utils.rnn.pack_padded_sequence(decoder_input,batch_sizes,batch_first=True)
                # a=decoder_hidden.unsqueeze(0)
    ...
    def _init_rnn_state(self, encoder_hidden):
        ...
        if isinstance(encoder_hidden, tuple):
            encoder_hidden = (encoder_hidden[0].unsqueeze(0),self._cat_directions(encoder_hidden[1]))
